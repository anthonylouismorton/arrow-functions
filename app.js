...
let greeting = name => `Hi, my name is ${name}`
// TODO: Uncomment the following line of code to see the output in the browser console
// Note that the arrow function will cause this method to break!
console.log(greeting(joe.name));
...
// };
let courseName = name => 'This student is enrolled in Code 301.';
...
//  this is an array that has joe's name, age, and hometown
// 2. What is "this" when joe.scopeArrow() is invoked?
//  This is the global window object when the arrow function is used
// 3. Explain why "this" is different when an arrow function is used.
//  This is different when an arrow function is used because this is not reset within an arrow function and the scope of this is everything surronding the function (the global window object)